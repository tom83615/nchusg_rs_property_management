<div id="item_edit">
    ...
    <form id = "edit" 
          action="http://localhost/nchusg_rs_property_management/index.php/rs_pm/edit_to_db"method="post">
    <?php ?>
    <b>ID　:</b><input type="text" name="id"   value="<?php echo $iId;?>" disabled 	="disabled"><br/><br/>
